...
public:
	...
	audioParamInfo()
	{
		...
		audioParam_ObjectArray[0].initializeSoniParams(1, 0, 1, 0, 0, 100);
		...
		audioParam_ObjectArray[6].initializeSoniParams(1, 0, 1, 0, 0, 100);
		...
		audioParam_ObjectArray[7].initializeSoniParams(1, 0, 1, 0, 0, 100);
